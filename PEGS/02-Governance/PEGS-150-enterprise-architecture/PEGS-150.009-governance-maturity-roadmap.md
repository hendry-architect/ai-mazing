...
```mermaid
flowchart LR
  L1["LEVEL 1<br/>Founder Startup"] --> L2["LEVEL 2<br/>Founder Enterprise<br/>◀ WE ARE HERE"] --> L3["LEVEL 3<br/>Executive Organization"] --> L4["LEVEL 4<br/>Institutional Enterprise"] --> L5["LEVEL 5<br/>Multi-Generational<br/>Family Office"]
```
