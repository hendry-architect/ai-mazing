...
```mermaid
timeline
    title Pascual Enterprise — Trajectory
    section Today (2026)
      Governance : PEGS ratified (000, 100, 101, libraries, templates, 150-series)
      People : Founder-led, deputies being named
      Operations : PassQual + declared entities (roster confirmation pending)
    section 24 Months (2028)
      Governance : Entities chartered, SAC seated, Level 3 maturity entered
      People : CEO/ELT roles chartered and filled, reviews running
      Capital : Waterfall behavioral, Foundation active, counsel engaged for structure
      Technology : AUT-002..007 live, dashboards automated
    section 5 Years (2031)
      Structure : Ascendencia Trust + Atemporal Holdings formed and funded
      Operations : Multi-entity portfolio, first acquisition integrated
      International : First international market entered (ES-language advantage)
      Maturity : Level 4 — Institutional Enterprise
    section 10 Years (2036)
      Legacy : Next generation in formation roles, Council rehearsed
      Capital : Investment/IP/RE entities operating, licensing revenue real
      Reach : Bilingual health platform at international scale
      Maturity : Level 5 — Multi-Generational Family Office
```
...
```mermaid
flowchart LR
  A["Entity roster confirmed<br/>(PEGS-100 amendment)"] --> B["Phase 4: instantiation<br/>(charters, matrices, calendars)"]
  B --> C["SAC seated + planning rhythm live"]
  B --> D["Automation build-out (AUT-002+)"]
  C --> E["Phase 6: counsel forms<br/>Trust + Holdings"]
  E --> F["Ownership migration to target state"]
  F --> G["Investment / IP / RE entities"]
  C --> H["First acquisition"]
  E --> I["Succession rehearsals"]
  G & H & I --> J["Level 5: Multi-generational family office"]
```
