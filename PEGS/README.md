...
| **5** | Instantiation — **Wave 1: Operational Deployment** (12-month plan, official calendar, cadence, quarterly/annual processes, ELT + Council meeting definitions, Italy Summit Dec 2026, live decision log + tracker) | 11-Meetings | 🔄 In review (PR #7) |
